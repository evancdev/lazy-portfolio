    ...
    >
      ...
      >
        <div className="flex flex-col lg:flex-row items-center justify-center gap-24 lg:gap-48">
          {/* Left Text Column */}
          <div className="w-full max-w-96 text-balance lg:text-left">
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed font-sans">
              that enjoys building random cool stuff like this realtime-updating portfolio because
              why not.
            </p>
          ...
          <motion.div
            ...
            className="w-full max-w-96 h-96 flex-shrink-0 border border-border rounded-xl flex items-center justify-center bg-muted/30 backdrop-blur-sm"
          >
